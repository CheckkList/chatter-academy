...
const sections = [
...

    {
        ...
        tasks: [
            "Обработать все непрочитанные и висящие сообщения, просмотреть последние диалоги на наличие неотвеченых сообщений (список ✏️IGNORE) и при наличии таких проработать их.",
            "Просмотреть по последним транзакциям на анкете на наличие активных секстингов или отсутствие добивок/послепродажного обслуживания.",
            ...
            "По ходу смены проверять список ✏️IGNORE, прописать фанов которым не ответили .",
            ...
            "По ходу смены проходится по онлайн фанам и онлайн платникам "Spenders Online".",
            "По ходу смены соблюдать периодичность рассылок, которую вам задает ваш ТимЛид, например - минимум 4 рассылки от OF за 8ми часовую смену."
        ]
    },

    {
        ...
        tasks: [
            ...
            "Конец рабочей смены, оповещение ТимЛида о окончании смены в рабочем чате, отчет по фанам, отчет по кассе и записать кассы в таблицу."
        ]
    }
];
